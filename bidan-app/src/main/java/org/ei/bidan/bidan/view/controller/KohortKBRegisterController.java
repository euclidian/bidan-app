            ...
            public KBClients fetch() {
                ...
                for (KartuIbu kartuIbu : kartuIbus) {
                    ...
                    KBClient kbClient = new KBClient(kartuIbu.getCaseId(), kartuIbu.getDetails().get("Namalengkap"),
                            ...
                            .withIMS(kartuIbu.getDetails().get("ALKI/IMS"))
                            .withHB(kartuIbu.getDetails().get("ALKI/HB"))
                            .withLila(kartuIbu.getDetails().get("ALKI/LILA"))
                            .withPenyakitKronis(kartuIbu.getDetails().get("ALKI/PenyakitKronis"))
