...
public class ANCStatusView extends RelativeLayout {
    ...
    private void setTextColorForPastDue() {
        lblEdd.setTextColor(getInstance().getColorResource(R.color.alert_urgent_red));
        txtEdd.setTextColor(getInstance().getColorResource(R.color.alert_urgent_red));
        lblDaysPastDue.setTextColor(getInstance().getColorResource(R.color.alert_urgent_red));
        txtDaysPastDue.setTextColor(getInstance().getColorResource(R.color.alert_urgent_red));
    }
