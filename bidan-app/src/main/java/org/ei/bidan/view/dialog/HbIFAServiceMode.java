...
import org.ei.bidan.util.FloatUtil;
...
import static org.ei.bidan.domain.ANCServiceType.HB_TEST;
import static org.ei.bidan.domain.ANCServiceType.IFA;
import static org.ei.bidan.view.contract.AlertDTO.emptyAlert;
import static org.ei.bidan.view.contract.AlertStatus.COMPLETE;
...
public class HbIFAServiceMode extends ServiceModeOption {
    ...
    @Override
    public String name() {
        return getInstance().getStringResource(R.string.anc_service_mode_hb_ifa);
    }
        ...
        return new SecuredNativeSmartRegisterActivity.ClientsHeaderProvider() {
            ...
            public int[] headerTextResourceIds() {
                return new int[]{
                        ...
                        R.string.header_hb, R.string.header_ifa};
            }
        };
    }
    ...
    public void setupHbDetailsLayout(ANCSmartRegisterClient client,
        ...
        for (ServiceProvidedDTO serviceProvided : client.allServicesProvidedForAServiceType(HB_TEST.displayName())) {
            ...
            ((TextView) hbDetailsViewGroup.findViewById(R.id.txt_hb_level)).setText(hbLevel + getInstance().getStringResource(R.string.anc_service_mode_hb_unit));
    ...
    public void setupIFADetailsLayout(ANCSmartRegisterClient client,
        ...
        for (ServiceProvidedDTO serviceProvided : client.allServicesProvidedForAServiceType(IFA.serviceName())) {
            ...
            ((TextView) ifaDetailsViewGroup.findViewById(R.id.txt_number_of_ifa_tablets))
                    .setText(numberOfIFATablets + getInstance().getStringResource(R.string.anc_service_mode_ifa_tablets));
