...
import org.ei.bidan.view.contract.pnc.PNCDetail;
import org.ei.bidan.view.contract.PregnancyOutcomeDetails;
...
public class PNCDetailControllerTest {
    ...
    private org.ei.bidan.view.contract.TimelineEvent eventFor(TimelineEvent pregnancyEvent, String expectedRelativeTime) {
        return new org.ei.bidan.view.contract.TimelineEvent(pregnancyEvent.type(), pregnancyEvent.title(), new String[]{pregnancyEvent.detail1(), pregnancyEvent.detail2()}, expectedRelativeTime);
    }
}
